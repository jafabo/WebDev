...
<body>
    ...
    <div class="container">
        ...
        <p>Before Kubernetes, managing containerized applications at scale was a challenge. Tools like Docker popularized containerization, but orchestrating them was still manual and complex.</p>
        ...
        <p>Kubernetes, also known as K8s, was released as an open-source project by Google in 2014. It was built upon Google's decade-plus years of experience in running massive-scale workloads using a system called Borg.</p>
        ...
        <p>By 2016, Kubernetes gained significant traction and became the de facto standard for container orchestration. The Cloud Native Computing Foundation (CNCF) adopted Kubernetes as its first project. 
        <a href="https://landscape.cncf.io/">More information on the CNCF can be found here!</a></p>
        ...
        <p>Today, Kubernetes is supported by an enormous community and has become the backbone of many modern infrastructures. It supports multi-cloud deployments, ensuring scalability, and high availability.</p>
